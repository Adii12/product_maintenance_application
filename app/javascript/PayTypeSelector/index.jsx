...
import SMSPayType from './SMSPayType';
...
class PayTypeSelector extends React.Component {
  ...
  render() {
    console.log("AHDUYGDYGDAUYDGUYSAGDUYAGDUYAGUYDAGIUDgUYASDGAUGDAUYDGUAIYDSGUAYDGAUYGDYASDASVDAVYDAYDTAGDUYTAGDASDUYA")      
    ...
    } else if (this.state.selectedPayType == "SMS") {
      PayTypeCustomComponent = SMSPayType;
    }
      ...
      <div>
        <div className="field">
          ...
          <select id="pay_type" onChange={this.onPayTypeSelected} name="order[pay_type]">
            ...
            <option value="SMS">{I18n.t("orders.form.pay_types.SMS")}</option>
          </select>
        </div>
